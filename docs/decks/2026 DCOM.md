...
With ui5-test-runner@5
parallel: 4 / probe-parallel: 20 : 20 min
parallel: 10 / probe-parallel: 20 : 15 min
...
Agent: core
* writes logs
  @ pos: bottom 0.809 top 0.107
  @ knee: 0.794
* writes report
  @ pos: right 0.747 auto auto
* requests Browser command
  @ pos: bottom 0.292 top 0.283
  @ channel: 0.448
@ x: 227
@ y: -209
@ width: 174
...
Agent: HTTP server
* writes logs
  @ pos: bottom 0.248 top 0.95
  @ knee: 0.798
* requests core "updates"
@ x: 714
@ y: -199
@ width: 120
@ height: 60
...
Agent: Page execution
multiplicity: true
* contains Browser command
* contains puppeteer
* contains chrome
@ x: 163
@ y: 120
...
* requests puppeteer "instantiates"
* writes logs
  @ pos: top 0.828 bottom 0.092
  @ knee: 0.636
@ x: 249
@ y: 160
@ width: 129
...
Note: browser_comments
details: "spawned process"
* annotates Browser command
@ x: 235
@ y: 282
@ width: 158
@ height: 60
...
Agent: core
* writes logs
  @ pos: right 0.751 auto auto
  @ knee: 0.794
* writes report
  @ pos: right 0.207 auto auto
* requests puppeteer
  @ channel: 0.483
* reads agent state
  @ pos: bottom 0.224 auto auto
  @ knee: 0.558
@ x: 236
@ y: -201
@ width: 218
...
Agent: agent
details: "injected by ui5-test-runner"
* writes agent state
@ x: 391
@ y: 218
@ width: 170
