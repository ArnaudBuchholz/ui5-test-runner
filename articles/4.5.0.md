...
The best way to introduce **testing strategies** is to describe the **test pyramid** : this visual concept enumerates the **different types** of tests and **quantifies** how much of each type should be done in an ideal project.

![Test pyramid](test-pyramid.png)

> Test pyramid with the equivalent technologies

At the bottom of the pyramid, the larger base, there are unit tests : they must be **cheap** to develop and **fast** to execute. On the opposite, at the top of the pyramid, manual tests are usually **expensive** and **slow**.
...
UI5 provides several tools to implement unit and component tests :

* [QUnit](https://qunitjs.com/) for unit tests,
* [OPA](https://ui5.sap.com/sdk/#/topic/22f175e7084247bc896c15280af9d1dc) for component tests.

The browse orders sample application provides examples of these tests :

* [Unit tests](https://ui5.sap.com/test-resources/sap/m/demokit/orderbrowser/webapp/test/unit/unitTests.qunit.html)
* [OPA tests](https://ui5.sap.com/test-resources/sap/m/demokit/orderbrowser/webapp/test/integration/opaTests.qunit.html)
