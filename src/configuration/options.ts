...
export const options = [
  ...
  {
    name: 'start',
    description: 'Start command (might be an NPM script or a shell command) ⚠️ the command is killed on tests completion',
    type: 'string',
  },
  {
    name: 'startWaitUrl',
  ...
  {
    name: 'startTimeout',
    description: 'Maximum waiting time for the start command (based on when the first URL becomes available, also used for termination)',
    type: 'timeout',
    default: 5000,
  },
  {
